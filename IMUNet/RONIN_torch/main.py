...
def get_dataset(root_dir, data_list, args, **kwargs):
    ...
    dataset = StridedSequenceDataset(
        ...
        ori_source=args.ori_source, use_init_rotor=not args.no_init_rotor)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ori_source', type=str, default='rv', choices=['rv', 'game_rv'],
                        help='Orientation sensor source for the "proposed" dataset (ProposedSequence only).')
    parser.add_argument('--no_init_rotor', action='store_true',
                        help='Disable ARCore-groundtruth init_rotor alignment (proposed dataset only); '
                             'matches real-time inference where no groundtruth orientation is available.')
